...
# It produces labels (comments) for each variable which are also saved as attributes (attr)

OSQ_daten_file = file.choose()
# setwd("./")
# OSQ_daten_file = "rdata_open-science-practices_2021-02-26_12-20.csv"
...
attr(OSQ_daten, "date") = "2021-02-26 12:20:40"
